...
#[derive(Debug)]
pub struct OKExAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OKExAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OKExAPI processing");
    
    let mut processor = OKExAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OKExAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OKExAPIProcessor::new(false);
